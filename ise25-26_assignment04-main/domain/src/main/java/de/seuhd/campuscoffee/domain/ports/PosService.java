...
public interface PosService {
     ...
     * @throws OsmApiException if the OSM API is unavailable or returns a server error
     * @throws OsmNodeMissingFieldsException if the OSM node lacks required fields for creating a valid POS
     * @throws DuplicatePosNameException if a POS with the same name already exists
     */
    @NonNull Pos importFromOsmNode(@NonNull Long nodeId) throws OsmNodeNotFoundException, OsmApiException, OsmNodeMissingFieldsException, DuplicatePosNameException;
}
